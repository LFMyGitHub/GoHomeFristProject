...
import com.example.modulecommon.widget.dialog.config.DialogConfig;
import com.example.modulecommon.widget.dialog.holder.AlertDialogHolder;
import com.example.modulecommon.widget.dialog.holder.SheetHolder;
...
public class Buildable {
    ...
    protected BuildBean buildMdLoading(BuildBean bean) {
        ...
        if (bean.isWhiteBg) {
            ...
            tvMsg.setTextColor(bean.mContext.getResources().getColor(R.color.color_333333));
        } else {
