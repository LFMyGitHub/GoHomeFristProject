package com.example.modulecommon.widget.dialog;
...
import com.example.modulecommon.widget.dialog.listener.DialogAssigner;
...
import com.example.modulecommon.widget.dialog.utils.ToolUtils;
import com.example.modulecommon.widget.dialog.widget.PopuWindowView;
    ...
    private static void showToast(String str, int showTime, int gravity) {
        ...
        if (gravity == Gravity.TOP) {
            if (mToastTop == null) {
                ...
                mToastTop.setGravity(gravity, 0, appContext.getResources().getDimensionPixelSize(R.dimen.size_64dp));
            }
            mToast = mToastTop;
            mToast.setText(str);
            mToast.show();
            ...
            if (mToastBottom == null) {
                ...
                mToastBottom.setGravity(gravity, 0, appContext.getResources().getDimensionPixelSize(R.dimen.size_64dp));
            }
            mToast = mToastBottom;
            mToast.setText(str);
            mToast.show();
